...
public class SubmitedController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        JFXTreeTableColumn<SubmittedForm, String> webRocketId = new JFXTreeTableColumn<>("Web Solar Id");
        ...
        JFXTreeTableColumn<SubmittedForm, String> stoveIdColumn = new JFXTreeTableColumn<>("Solar Id");
        ...
        List<SubmittedForm> solarForms = this.solarFormService.succeedList();
        
        forms.addAll(solarForms);
