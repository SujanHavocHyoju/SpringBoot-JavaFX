...
public class GoogleCloudService {
    ...
    private static final java.io.File DATA_STORE_DIR = new java.io.File(
            System.getProperty("user.home"), ".credentials/solar");
        ...
        for (File file : files) {
            ...
            if (!fileIO.exists()) {
                if (extension.equalsIgnoreCase("json")) {
                    ...
                    log.info("File is downloading :" + fileIO.getAbsolutePath());
                    this.solarFormService.processFormByFile(fileIO);
                    log.info("Deleting file from drive");
