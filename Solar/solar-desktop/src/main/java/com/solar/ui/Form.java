...
public class Form extends RecursiveTreeObject<Form> {
    ...
    public Form(int sn,String stoveId, String fullName, String citizenShipNumber, String citizenDistrict) {
        ...
        this.solarId = new SimpleStringProperty(stoveId);
    ...
    public String toString() {
        return "Form{" + "stoveId=" + solarId + ", fullName=" + fullName + ", citizenShipNumber=" + citizenShipNumber + ", citizenDistrict=" + citizenDistrict + '}';
    }
